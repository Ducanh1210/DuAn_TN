...
<head>
    ...
    <style>
        ...
        .auth-container {
            ...
            z-index: 2;
            width: 100%;
            max-width: 440px; /* Slightly wider for register */
            padding: 32px 28px;
    ...
    <div class="auth-container">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="username" name="username" class="form-control" placeholder="Tên đăng nhập (ví dụ: nguyenvan_a)" value="{{ old('username') }}" required autofocus>
            </div>
            
            <div class="form-group">
                <label for="email">Email <span style="color:red">*</span></label>
                <input type="email" id="email" name="email" class="form-control" placeholder="Email của bạn" value="{{ old('email') }}" required>
            </div>

            <div class="form-group">
                <label for="display_name">Tên hiển thị</label>
                <input type="text" id="display_name" name="display_name" class="form-control" placeholder="Tên hiển thị trên bản đồ" value="{{ old('display_name') }}">
            </div>
