            ...
            <div class="col-md-4 border-start" style="border-color: var(--border-light) !important;">
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control form-control-sm @error('lat') is-invalid @enderror" id="lat" name="lat" value="{{ old('lat') }}" required style="border-color: #e2e8f0;">
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control form-control-sm @error('lng') is-invalid @enderror" id="lng" name="lng" value="{{ old('lng') }}" required style="border-color: #e2e8f0;">
