    ...
    <div class="form-card card">
        ...
        <div class="card-body">
            ...
            <div class="mb-0">
                ...
                <textarea class="form-control @error('content') is-invalid @enderror" id="content" name="content" rows="14" required>{{ old('content') }}</textarea>
    ...
    <div class="form-card card">
        ...
        <div class="card-body">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('admin.news.index') }}" class="btn btn-secondary flex-grow-1"><i class="fas fa-arrow-left me-1"></i>Hủy</a>
