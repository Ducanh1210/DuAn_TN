    ...
    <div class="col-lg-8">
        <div class="card-minimal p-4 mb-4">
            ...
            <div class="mb-0">
                ...
                <textarea class="form-control form-control-sm @error('content') is-invalid @enderror" id="content" name="content" rows="14" style="border-color: #e2e8f0;">{{ old('content', $news->content) }}</textarea>
