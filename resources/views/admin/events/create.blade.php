    ...
    <div class="col-lg-8">
        <div class="card-minimal p-4 mb-4">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control form-control-sm @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" required style="border-color: #e2e8f0;">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control form-control-sm" id="program" name="program" rows="6" placeholder="Nội dung chi tiết chương trình sự kiện...">{{ old('program') }}</textarea>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="datetime-local" class="form-control form-control-sm @error('start_time') is-invalid @enderror" id="start_time" name="start_time" value="{{ old('start_time') }}" required style="border-color: #e2e8f0;">
                ...
                <div class="col-md-6">
                    ...
                    <input type="datetime-local" class="form-control form-control-sm @error('end_time') is-invalid @enderror" id="end_time" name="end_time" value="{{ old('end_time') }}" required style="border-color: #e2e8f0;">
    ...
    <div class="col-lg-4">
        ...
        <div class="card-minimal p-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control form-control-sm" id="location_text" name="location_text" value="{{ old('location_text') }}" placeholder="VD: Chùa Bà Đanh, Kim Bảng" style="border-color: #e2e8f0;">
            </div>
            <div class="mb-3">
            ...
            <div class="d-flex gap-2 pt-2 border-top" style="border-color: var(--border-light) !important;">
                ...
                <button type="submit" class="btn-minimal btn-minimal-primary flex-fill">Lưu</button>
            </div>
        </div>
    </div>
</div>
