        ...
        <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-md-9">
                    ...
                    @if($category->icon)
                        <div class="mb-2">
                            <img src="{{ asset($category->icon) }}" alt="Icon" style="height: 40px; width: auto; object-fit: contain;">
                        </div>
                    @endif
                ...
                <div class="col-md-3">
                    ...
                    <input type="color" class="form-control form-control-color w-100 @error('icon_color') is-invalid @enderror" id="icon_color" name="icon_color" value="{{ old('icon_color', $category->icon_color ?? '#ef4444') }}" title="Chọn màu cho ghim">
