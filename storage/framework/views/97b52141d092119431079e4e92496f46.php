...
<head>
    ...
    <title>Đăng ký - Hà Nam POI</title>
    ...
    <style>
        ...
        .auth-container::-webkit-scrollbar-thumb { background: rgba(0,0,0,0.1); border-radius: 10px; }
...
<body>
    ...
    <div class="auth-container">
        ...
        <div class="auth-subtitle">Tạo tài khoản để lưu các địa điểm yêu thích</div>
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" id="username" name="username" class="form-control" placeholder="Tên đăng nhập (ví dụ: nguyenvan_a)" value="<?php echo e(old('username')); ?>" required autofocus>
            </div>
            
            <div class="form-group">
                <label for="email">Email <span style="color:red">*</span></label>
                <input type="email" id="email" name="email" class="form-control" placeholder="Email của bạn" value="<?php echo e(old('email')); ?>" required>
            </div>

            <div class="form-group">
                <label for="display_name">Tên hiển thị</label>
                <input type="text" id="display_name" name="display_name" class="form-control" placeholder="Tên hiển thị trên bản đồ" value="<?php echo e(old('display_name')); ?>">
            </div>
            
            <div class="form-group">
                <label for="password">Mật khẩu <span style="color:red">*</span></label>
                <input type="password" id="password" name="password" class="form-control" placeholder="Mật khẩu (ít nhất 6 ký tự)" required>
            </div>
...
<?php /**PATH D:\laragon\www\datnv2\DuAn_TN\resources\views/client/auth/register.blade.php ENDPATH**/ ?>