...
<div class="top-navbar">
    <a href="<?php echo e(route('client.profile')); ?>" class="btn-back">
                            ...
                            <div class="phone-screen">
                                ...
                                <div class="mock-business-card">
                                    ...
                                    <div class="mock-info-rows">
                                        ...
                                        <div class="mock-info-row">
                                            <span class="mock-info-icon">📞</span>
                                            <span id="mockBizPhone"><?php echo e(Auth::user()->phone ?? 'Chưa cập nhật SĐT'); ?></span>
                                        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (bizForm) {
            ...
            function setupUploader(dropzoneId, fileInputId, previewsId, previewArray) {
                ...
                function handleFiles(files) {
                    Array.from(files).forEach(file => {
                        ...
                        fetch("<?php echo e(route('client.profile.business.upload_photo')); ?>", {
                            method: 'POST',
                            body: formData
                        })
                        .then(res => res.json())
            ...
            function submitBizRegistrationForm() {
                ...
                fetch("<?php echo e(route('client.profile.business.register')); ?>", {
                    method: 'POST',
                    headers: {
...
<?php /**PATH D:\laragon\www\Du_An_TN\resources\views/client/business_upgrade.blade.php ENDPATH**/ ?>