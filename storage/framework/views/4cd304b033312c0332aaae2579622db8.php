...
<div class="d-flex align-items-center justify-content-between mb-4">
    ...
    <div class="text-muted" style="font-size: 0.875rem;">
        <i class="far fa-calendar-alt me-1"></i> Today is <?php echo e(\Carbon\Carbon::now()->format('F j, Y')); ?>
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <div>
                        ...
                        <h3 class="fw-bold mb-0 text-dark tracking-tight"><?php echo e(\App\Models\Location::count()); ?></h3>
                    </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <div>
                        ...
                        <h3 class="fw-bold mb-0 text-dark tracking-tight"><?php echo e(\App\Models\News::count() + \App\Models\Event::count()); ?></h3>
                    </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <div>
                        ...
                        <h3 class="fw-bold mb-0 text-dark tracking-tight"><?php echo e(\App\Models\User::count()); ?></h3>
                    </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <div>
                        ...
                        <h3 class="fw-bold mb-0 text-dark tracking-tight"><?php echo e(\App\Models\Comment::where('created_at', '>=', now()->subDays(7))->count()); ?></h3>
                    </div>
    ...
    <div class="col-12 col-lg-4">
        <div class="card panel-card h-100">
            <div class="card-header bg-transparent border-bottom px-4 py-3 d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('admin.users.index')); ?>" class="text-primary text-decoration-none small fw-semibold">Xem tất cả</a>
            </div>
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item px-4 py-3 border-bottom-0 user-item d-flex align-items-center transition-all">
                        <div class="avatar me-3 rounded-circle d-flex align-items-center justify-content-center fw-bold" 
                            ...
                            <?php echo e(strtoupper(substr($user->display_name ?? $user->username ?? 'U', 0, 1))); ?>

                        </div>
                        <div class="flex-grow-1 overflow-hidden">
                            <h6 class="mb-0 fw-semibold text-dark text-truncate" style="font-size: 0.875rem;"><?php echo e($user->display_name ?? $user->username); ?></h6>
                            <small class="text-muted text-truncate d-block" style="font-size: 0.75rem;"><?php echo e($user->email); ?></small>
                        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\Du_An_TN\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>