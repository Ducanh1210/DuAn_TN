<?php $__env->startSection('title', 'Thêm Sự Kiện Mới'); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="program" name="program" rows="6" placeholder="Nội dung chi tiết chương trình sự kiện..."><?php echo e(old('program')); ?></textarea>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
    ...
    <div class="form-card card">
        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="location_text" name="location_text" value="<?php echo e(old('location_text')); ?>" placeholder="VD: Chùa Bà Đanh, Kim Bảng">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="status" name="status">
                    <option value="active" <?php echo e(old('status','active')=='active'?'selected':''); ?>>✅ Đang diễn ra</option>
            ...
            <div class="d-flex gap-2">
                <a href="<?php echo e(route('admin.events.index')); ?>" class="btn btn-secondary flex-grow-1"><i class="fas fa-arrow-left me-1"></i>Hủy</a>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\Du_An_TN\resources\views/admin/events/create.blade.php ENDPATH**/ ?>